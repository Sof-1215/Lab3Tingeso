...
const evaluation = async(id) => {
  try {
    const response = await axios.post(
      `http://localhost:8090/api/v1/loansolicitude/evaluation/${id}`);
...
export default { store, evaluation, getLoanSolicitudes, getLoanSolicitudeById, getAll, updateLoanSolicitude };